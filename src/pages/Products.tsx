      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-accent text-accent-foreground px-8 py-4 rounded-full font-body font-medium text-lg hover:bg-accent/90 transition-colors"
          >
            <Instagram size={22} />
            @{INSTAGRAM_HANDLE}
